class DogGameMainMenuState extends AppState {
    ...
    static moveToNextStateToStartGame(stateMachine) {
        this.menu.dismiss();
        resetPlayField();
        stateMachine.changeState(DogGamePlayingState, this.menu); // Assuming stateMachine is properly defined
    }
